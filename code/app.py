...
data4 = {'DateTime':r1_timestamp,'Product Separator Temp':r1_inlet_temp}
df4 = pd.DataFrame(data3)

data5 = {'DateTime':r2_timestamp,'Product Separator Temp':r2_inlet_temp}
df5 = pd.DataFrame(data3)

data6 = {'DateTime':r3_timestamp,'Product Separator Temp':r3_inlet_temp}
